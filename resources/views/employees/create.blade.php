        ...
        <form action="{{ route('employees.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="leave_balance" id="leave_balance" min="0" value="{{ old('leave_balance', 12) }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-white transition-colors" required>
                ...
                <div>
                    ...
                    <input type="text" name="no_rfid" id="no_rfid" value="{{ old('no_rfid') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-white transition-colors" placeholder="Contoh: 2E C7 F9 05">
