/*
 * =============================================================================
 * FIRMWARE AKSES PINTU - ESP32 #2 (KELUAR)
 * =============================================================================
 * Deskripsi:
 *   ESP32 ini dipasang di sisi DALAM ruangan sebagai pintu KELUAR.
 *   Membaca RFID -> mengirim UID + direction "keluar" ke broker MQTT ->
...
// ID unik untuk ESP ini (bedakan dengan ESP Masuk!)
const char* DEVICE_ID     = "ESP32-PINTU-KELUAR";
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n===================================");
  Serial.println("  PINTU KELUAR - SISTEM RFID AKTIF ");
  Serial.println("===================================");
...
void mqttCallback(char* topic, byte* payload, unsigned int length) {
  ...
  // Hanya proses command yang ditujukan untuk "keluar" atau broadcast (tanpa direction)
